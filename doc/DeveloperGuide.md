...
1. User requests to list persons
2. AddressBook shows a list of persons
3. User requests to edit tag of a specific person in the list
4. AddressBook edits tag of the person <br>
Use case ends.
...
3b. Specified tag to edit does not exist

> 3b1. AddressBook shows an error message <br>
  Use case resumes at step 2
  
3c. New tag is the same as specified tag to edit
